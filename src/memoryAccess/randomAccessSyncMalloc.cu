...
#define NODEPADDING (1024*16)  //Each node has an independence padding 
...
#define ADJACENCYLISTNUMBER 128 // Each node has the maximum number, this also can be read from dynamic allocation
...
int main(void)
{
    ...
    long long N = 1024LL*1024LL*1024LL*16;
