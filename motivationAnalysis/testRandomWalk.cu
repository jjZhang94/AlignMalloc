...
#define NODEPADDING 8192*2  //Each node has an independence padding 
...
#define ADJACENCYLISTNUMBER 2048 // Each node has the maximum number, this also can be read from dynamic allocation
